...
public interface TagsRepository extends Neo4jRepository<Tags,Long> {
    ...
    @Query("match (n:Tags) where exists(n.count) return n order by toInt(n.count) DESC limit 10")
    List<Tags> findHottestTags();

    @Query("match (n:Tags) where exists(n.count_2015) return n order by toInt(n.count_2015) DESC limit 10")
    List<Tags> findHottestTags2015();

    @Query("match (n:Tags) where exists(n.count_2016) return n order by toInt(n.count_2016) DESC limit 10")
    List<Tags> findHottestTags2016();

    @Query("match (n:Tags) where exists(n.count_2017) return n order by toInt(n.count_2017) DESC limit 10")
    List<Tags> findHottestTags2017();

    @Query("match (n:Tags) where exists(n.count_2018) return n order by toInt(n.count_2018) DESC limit 10")
    List<Tags> findHottestTags2018();

    @Query("match (n:Tags) where exists(n.count_2019) return n order by toInt(n.count_2019) DESC limit 10")
    List<Tags> findHottestTags2019();

    @Query("match (n:Tags) where exists(n.count_2020) return n order by toInt(n.count_2020) DESC limit 10")
    List<Tags> findHottestTags2020();

    @Query("match (n:Tags) where exists(n.count_2021) return n order by toInt(n.count_2021) DESC limit 10")
