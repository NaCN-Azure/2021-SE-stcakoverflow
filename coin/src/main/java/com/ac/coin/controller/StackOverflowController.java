...
public class StackOverflowController {
    ...
    public ResponseVO findTargetNodesInfo(@RequestParam(name="name",required=true) String name){
    ...
    @ResponseStatus(value= HttpStatus.OK)
    public ResponseVO findTargetNodesDescription(@RequestParam(name="name",required=true) String name){
    ...
    @ResponseStatus(value= HttpStatus.OK)
    public ResponseVO findTargetNodesRelated(@RequestParam(name="name",required=true) String name){
    ...
    @ResponseStatus(value= HttpStatus.OK)
    public ResponseVO findTargetQuestions(@RequestParam(name="name",required=true) String name) {
        return ResponseVO.buildSuccess(stackOverflowService.findHotQuestions(name));//返回最热五个问题
    }

    @GetMapping("/findTargetNodesChart")
    @ResponseStatus(value= HttpStatus.OK)
    public ResponseVO findTargetNodesChart(@RequestParam(name="name",required = true) String name){
    ...
    @ResponseStatus(value= HttpStatus.OK)
    public ResponseVO findNodesFuzzy(@RequestParam(name="name",required=true) String name){
