    ...
    <div class="header">
      ...
      <div class="option-button-area" v-show="fullWidth">
        ...
        <el-popover
          ...
          content="图谱复位"
          :open-delay=1000>
          <el-button slot="reference" icon="el-icon-refresh-right" class="option-button" size="small" v-show="modelSelect==='力导图模式'"></el-button>
        </el-popover>
        ...
        <el-popover
          ...
          :open-delay=1000>
          <el-button slot="reference" icon="el-icon-download" class="option-button" size="small" v-show="modelSelect==='力导图模式'"></el-button>
        </el-popover>
        <el-dialog
        ...
        <el-button slot="reference" icon="el-icon-search" class="option-button" size="small" v-show="modelSelect==='力导图模式'"
        ...
        <el-popover
          ...
          :open-delay=1000>
          <el-button slot="reference" icon="el-icon-data-analysis" class="option-button" size="small" v-show="modelSelect==='力导图模式'"></el-button>
        </el-popover>
        ...
        <el-popover
          ...
          :open-delay=1000>
          <el-button slot="reference" icon="el-icon-delete" class="option-button" size="small" v-show="modelSelect==='力导图模式'"></el-button>
        </el-popover>
      </div>
